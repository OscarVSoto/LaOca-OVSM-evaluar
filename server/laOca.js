...
function Posada(){
	this.titulo="Posada";
	this.castigo=1;
	this.mensaje="Has caído en la posada, un turno sin tirar.";
	this.cae=function(ficha){
		console.log(this.mensaje);
...
this.titulo="Pozo";
	this.castigo=2;
	this.mensaje="Has caído en el pozo, dos turnos sin tirar.";
	this.cae=function(ficha){
		console.log(this.mensaje);
		ficha.jugador.castigo=this.castigo;
		ficha.cambiarTurno();
...
function Laberinto(){
	...
	this.castigo=3;
	this.mensaje="Has caído en el laberinto, tres turno sin tirar.";
	this.cae=function(ficha){
		console.log(this.mensaje);
		ficha.jugador.castigo=this.castigo;
		ficha.cambiarTurno();
...
function Carcel(){
	this.titulo="Carcel";
	this.castigo=4;
	this.mensaje="Has caído en la carcel, cuatro turno sin tirar.";
	this.cae=function(ficha){
		console.log(this.mensaje);
		ficha.jugador.castigo=this.castigo;
		ficha.cambiarTurno();
